const Cards = [
  {
    ...
    description:
      "A proper comfort-food classic, this tuna melt made with soft, fluffy slices of Hovis Soft White medium sliced bread is packed with a rich and creamy tuna filling, melted cheddar and mozzarella, and a touch of heat from pickled jalapeños. Finished with crisp salad leaves and served wrapped and sliced for that Instagram-worthy moment.",
  },
  {
  ...
  },
  {
    ...
    description:
      "In this moreish starter from Cristina Bowerman, foie gras is sautéed and served in a liquorice bread roll with a tangy mango ketchup. To finish the dish the chef adds a handful of crunchy vegetable chips and her delicious mayonnaise, which is subtly flavoured with Passito di Pantelleria, an Italian sweet wine.",
  },
  {
    image: "./images/vegetarian-sandwich.webp",
    title: "Vegetarian sandwich",
    description:
      "It's also a good idea to mix up rich ingredients such as mayonnaise, or richly spiced spreads like harissa with fresher ingredients, to ensure you have a good balance. Dressing your salad leaves will add personality to a veggie sandwich, and make sure to explore options for adding herbal fragrance (e.g. pesto) and acidity (e.g lemon juice or pickles). ",
  },
  {
